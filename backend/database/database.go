...
func (this *Database) upgradeFrom(version int) {
	...
	// TODO -- This would be nice to have to reduce bandwidth usage
	/*if version < 6 {
		this.upgradeTo(6, `
				ALTER TABLE feeds ADD COLUMN updatedtime TIMESTAMP NOT NULL DEFAULT
						'1970-01-01 00:00:00+00:00';
				ALTER TABLE items ADD COLUMN updatedtime TIMESTAMP NOT NULL DEFAULT
						'1970-01-01 00:00:00+00:00';`)
	}*/ // version < 6
}
